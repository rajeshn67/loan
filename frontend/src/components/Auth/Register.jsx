    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-50 to-primary-100">
      <div className="max-w-md w-full space-y-8 p-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">Join the loan recovery system</p>
        </div>
        ...
        <div className="grid grid-cols-2 gap-4 mt-8">
          <div className="card p-4 text-center">
            ...
            <h3 className="font-medium text-gray-900">Bank Staff</h3>
            <p className="text-xs text-gray-600 mt-1">Add loans, assign agents</p>
          </div>
          <div className="card p-4 text-center">
            <Users className="h-6 w-6 text-success-600 mx-auto mb-2" />
            <h3 className="font-medium text-gray-900">Recovery Agent</h3>
            <p className="text-xs text-gray-600 mt-1">Collect loan payments</p>
          </div>
        </div>
      </div>
    </div>
